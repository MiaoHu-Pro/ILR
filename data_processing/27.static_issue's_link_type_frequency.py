...
if __name__ == "__main__":
    ...
    entity2obj = read_enttiy2obj("../data/Apache/Apache_issue_links.txt")
    row, colum = entity2obj.shape
    print(row, colum)
    entity_type = []
    for i in range(row):
        entity_type.append(entity2obj[i][1])

    static_frequency("../data/Apache/total_link_type_frequency.txt",entity_type)
