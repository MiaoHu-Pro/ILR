...
if __name__ == "__main__":
    ...
    for _folder in file_name:
        ...
        entity2id_path = "../data/" + _folder + "/entity2id.txt"
        relation2id_path = "../data/" + _folder + "/relation2id.txt"
        entity2id_dic, relation2id_dic = get_entity_relation_2id(entity2id_path, relation2id_path)

        _train = read_files("../data/" + _folder + "/total_triples_with_created_time.txt")
        ...
        write_data_2_id("../data/" + _folder + "/total_triples2id.txt", data2id)
