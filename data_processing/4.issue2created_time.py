...
def get_entity2time(rank_path):
    ...
    for d in f:
        ...
        _entity2time.append(head)
        _entity2time.append(id)
        _entity2time.append(created_time)
        x_obj.append(_entity2time)
...
if __name__ == "__main__":
    ...
    for file in file_name:
        ...
        entity2time = get_entity2time(path)

        write_entity2time("./entity_id_time/" + file.split("_")[0] + "_entity_id_time.txt", entity2time)
